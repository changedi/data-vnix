...
import static com.taobao.wdm.csv.Constants.COMMENT;
import static com.taobao.wdm.csv.Constants.CR;
import static com.taobao.wdm.csv.Constants.LF;
import static com.taobao.wdm.csv.Constants.SP;
...
public final class CSVPrinter implements Flushable, Closeable {
	 ...
	 * supported. Hybrid formats (encapsulation and escaping with a different
	...
	/**
	 * Prints a single line of delimiter separated values. The values will be
	 * quoted if needed. Quotes and newLine characters will be escaped.
	 * 
	 * @param values
	 *            values to output.
	 * @throws IOException
	 ...
	 * line. The character specified to start comments and a space will be
	...
	/*
	 * Note: must only be called if escaping is enabled, otherwise will generate
	 * NPE
	 */
	...
	/*
	 * Note: must only be called if quoting is enabled, otherwise will generate
	 * NPE
	 */
	// the original object is needed so can check for Number
	private void printAndQuote(final Object object, final CharSequence value,
		...
		while (pos < end) {
			...
			if (c == quoteChar) {
				...
				// write it out again with the next string (effectively doubling
				// it)
				start = pos;
			}
			pos++;

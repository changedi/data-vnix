 ...
 * see the next char returned by {@link #read()}.
 * 
 * @version $Id: ExtendedBufferedReader.java 1512625 2013-08-10 11:07:15Z
 *          britter $
 */
final class ExtendedBufferedReader extends BufferedReader {
	 ...
	 * not include a character read using the {@link #lookAhead()} method. If no
	 * character has been read then this will return {@link Constants#UNDEFINED}
	 * . If the end of the stream was reached on the last read then this will
	 ...
	 * terminator(s). This method should only be called when processing a
	 ...
	 * the next call to {@link #read()} will still return this value. Does not
